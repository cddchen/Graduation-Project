...
\begin{table}[htb]
    ...
    \setlength{\tabcolsep}{7mm}{
        \begin{tabular}{|c|c|}
            ...
            终点& 0.1 5 0.1\\
            \hline
            障碍物1& 0.25 0.3 0.25 0.8 0.5 0 0.5\\
            \hline
            障碍物2& 1.1 0.8 1.1 2.9 2.2 0 0.5\\
            \hline
            障碍物3& 0.25 2.9 0.25 3.4 0.5 0 0.5\\
            \hline
            障碍物4& 0.9 4 0.9 4.5 1.8 0 2\\
            \hline
            障碍物5& 3 0.8 3 2.9 0.6 0 1\\
            \hline
            精度& 0.1\\
            \hline
        \end{tabular}
...
\begin{table}[htb]
    ...
    \setlength{\tabcolsep}{7mm}{
        \begin{tabular}{|c|c|}
            ...
            终点& 1 50 1\\
            \hline
            障碍物1& [(0, 2), (5, 2), (5, 8), (0, 8)], (0, 5)\\
            \hline
            障碍物2& [(0, 8), (22, 8), (22, 28), (0, 28)], (0, 5)\\
            \hline
            障碍物3& [(0, 28), (5, 28), (5, 34), (0, 34)], (0, 5)\\
            \hline
            障碍物4& [(0, 40), (18, 40), (18, 45), (0, 45)], (0, 20)\\
            \hline
            障碍物5& [(27, 8), (32, 8), (32, 28), (27, 28)], (0, 10)\\
            \hline
        \end{tabular}
    }
\end{table}
...
\begin{table}[htb]
    ...
    \begin{tabular}{|c|c|}
        ...
        终点& 0.1 5 0.1\\
        \hline
        \multirow{24}*{障碍物}&1.35 0 1.35 0.1 2.7 0 2\\
        \cline{2-2}
...
\begin{table}[htb]
    ...
    \begin{tabular}{|c|c|}
        ...
        终点& 0.1 5 0.1\\
        \hline
        \multirow{24}*{障碍物}&[(0, 0), (27, 0), (27, 1), (0, 1)], (0, 20)\\
        \cline{2-2}
...
\begin{table}[htb]
    ...
    \begin{tabular}{|c|c|}
        ...
        终点& 0.1 5 0.1\\
        \hline
        \multirow{10}*{障碍物}&0.25 0.3 0.25 0.8 0.5 0 0.5\\
        \cline{2-2}
        &1.1 0.8 1.1 2.9 2.2 0 0.5\\
        \cline{2-2}
        &0.25 2.9 0.25 3.4 0.5 0 0.5\\
...
\begin{table}[htb]
    ...
    \setlength{\tabcolsep}{7mm}{
        \begin{tabular}{|c|c|}
            ...
            终点& 1 50 1\\
            \hline
            \multirow{10}*{障碍物}&[(0, 2), (5, 2), (5, 8), (0, 8)], (0, 5)\\
            \cline{2-2}
            &[(0, 8), (22, 8), (22, 28), (0, 28)], (0, 5)\\
            \cline{2-2}
            &[(0, 28), (5, 28), (5, 34), (0, 34)], (0, 5)\\
